...
In your report, describe the statistical analsysi that you used for estimating the warmest and coldest days at each station, including writing down any statistical models in mathematical notation. Be sure to define all your symbols and assumptions. 

Interpolate mpas of the warmest and coldest days, and plot the interpolated maps of warmest and coldest days. 
...
4. Make a single plot of the estimated yearly cycles for 10 different stations, highlighting a dvierstiy of climates around the contiguous USA. Your plot should clearly indicate which cycle is from which station. 
