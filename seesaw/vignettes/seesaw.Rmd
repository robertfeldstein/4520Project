...
vignette: "%\\VignetteIndexEntry{seesaw} %\\VignetteEngine{knitr::rmarkdown} %\\VignetteEncoding{UTF-8}\n"
---
...
temp_trends <- suppressWarnings(sapply(station_info$station_id, 
                                       seesaw::trend_of_temps))
