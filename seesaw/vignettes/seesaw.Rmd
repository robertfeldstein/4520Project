...
locs <- X[, c("x", "y")]
X$elevation <- elevatr::get_elev_point(locs, prj = st_crs(usa_boundary))$elevation
...
is actually in Ontario, Canada. Interestingly, NOAA includes one Canadian station
in their dataset. Although not technically a part of the "lower 48" it still
includes valuable data for the region.
