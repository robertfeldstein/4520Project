...
res <- 100
spatial_model <- seesaw::interpolate_grid("2024-03-01", "2024-03-31", "T_DAILY_AVG", res)
grid <- usagrid(res)
seesaw::graph_interp(spatial_model, grid) + labs(x = "Longitude", y = "Latitude", fill = "Interpolated Average Temperature")
...
stations <- c("94645", "04223", "53169", "04131", "53182", "12987", "63849", 
              "92826", "54810", "03761")
names <- c("Maine", "Washington", "Arizona", "Wyoming", "Oklahoma", "Texas", 
