...
1. A map of the average temperature at each station for March 2024.
...
2. A spatial model and plot an interpolated map of average temperatures for 
March 2024. 
...
3. Plots of the warmest and coldest day of the year for each station.
...
Interpolated maps of the warmest and coldest days:
...
4. A single plot of the estimated yearly cycles for 10 different stations, 
...
5. Estimated trends over the years for each station, in units of degrees 
Celsius per year. 
...
Interpolated estimated trends to a grid, using only significant points: 
